...
// 查询评论
export const evaluateList = (goodId)=>{
	return http.get(`/api/goods/evaluateList/${goodId}`, null)
}

// 新增评论
export const evaluateGoods = (goodId, content)=>{
	let param = {
		userId: uni.getStorageSync("userId"),
		goodsId: goodId,
		content: content
	}
	return http.post(`/api/goods/evaluate`, param)
}

// 删除评论
export const deleteEvaluate = (evaluateId)=>{
	return http.post(`/api/goods/deleteEvaluate/${evaluateId}`, null)
}