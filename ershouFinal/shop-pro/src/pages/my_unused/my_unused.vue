	...
	<view class="page-box">
		<view class="order" v-for="(item, index) in list" :key="item.goodsId">
			<view class="top">
				...
				<view style="color: #82848a;" v-if="item.status == '0' && item.sellStatus == '0'" class="right">已上架</view>
				<view style="color: #FF7670;" v-if="item.status == '1' && item.sellStatus == '0'" class="right">已下架</view>
			</view>
			<view class="item">
				<view class="left">
			...
			<view class="bottom">
				...
				<view @click="upanddownBtn(item)" class="exchange btn" v-if="item.sellStatus === '0'">
					<spna v-if="item.status == '0'">下架</spna>
					<spna v-if="item.status == '1'">上架</spna>
				</view>
				<view @click="editBtn(item)" class="evaluate btn" v-if="item.sellStatus === '0'">编辑</view>
				<view @click="deleteBtn(item)" class="evaluate btn" v-if="item.sellStatus === '0'">删除</view>
			</view>
		</view>
